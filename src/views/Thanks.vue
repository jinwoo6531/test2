  ...
  >
    <v-layout wrap class="pa-6 ma-0">
      ...
      <v-flex
        ...
        sm12
        md12
        class="d-flex justify-center align-top text-center pa-0"
      ...
      <v-flex
        ...
        sm12
        md12
        class="d-flex justify-center align-top text-center"
      >
        <v-card class="text-center" color="transparent" flat tile>
          <v-card-text class="thanks-call pa-0"
            >타시오와 함께<br />행복한 여정이 되시길 바랄게요!</v-card-text
          >
        </v-card>
      </v-flex>
