...
export default {
    ...
    methods: {
        requestPay() {
            ...
            IMP.request_pay({ // param
                ...
                if (rsp.success) {
                    ...
                    axios({
                        url: 'https://connector.tasio.io/tasio-288c5/us-central1/app/api/read/api/payment/put', // 가맹점 서버
                        method: "post",
                        headers: {
        ...
        cancelPay() {
            ...
            if (this.isrefund == '0') {
                axios({
                    url: "https://connector.tasio.io/tasio-288c5/us-central1/app/api/read/api/payment/cancel",
                    method: "post",
                    headers: {
                        'content-type': 'application/x-www-form-urlencoded'
                    },
