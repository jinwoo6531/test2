            ...
            <div class="col-sm-8 offset-sm-2">
                <div>
                    ...
                    <form @submit.prevent="handleSubmit">
                        ...
                        <div class="form-group">
                            <label for="terms" class="checkbox">I agree to the terms and conditions.</label>
                                <input id="terms" name="terms" v-validate="'required'" type="checkbox" class="form-control">
