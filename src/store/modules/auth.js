...
const actions = {
  ...
  verifyOtp(_, {
    ...
    window.confirmationResult
      .confirm(otp)
      .then(result => {
        axios.get('http://34.64.137.217:1994/tasio-288c5/us-central1/app/api/read/' + result.user.uid)
          .then(response => {
            alert('인증이 완료되었습니다.')
  ...
  fetchUser({
    ...
    if (user) {
      axios.get('http://34.64.137.217:1994/tasio-288c5/us-central1/app/api/read/' + user.uid)
        .then(async response => {
