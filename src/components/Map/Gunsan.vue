                ...
                <v-flex class="pa-0 selectBox" xs12 sm12 md12 lg12 xl12>
                    <v-flex class="pa-4 pt-0" xs12 sm12 md12 lg12 xl12>
                        ...
                        >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span
                                            v-else
                                            @click="selectPerson"
                                            style="color: #262626; padding-left: 12px;"
                                            >탑승인원 선택</span
                                        >
                                    </v-btn>
                                </span>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <v-card-text
                                            style="position: absolute; top: 158px; text-align: center; font-family: Noto Sans KR; font-style: normal; font-weight: 500; font-size: 16px; color: #262626;"
                                            >탑승인원 선택</v-card-text
                                        >
                                        <v-card
                        ...
                        >
                            <v-flex
                                class="mb-3"
                                style="background: #E61773; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 3px; display: inline-block;"
                            >
                                <p
                                    class="ma-0"
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        />
                                        <span
                                            style="vertical-align: middle; font-style: normal; font-weight: normal; font-size: 14px; color: #FFF;"
                                            >소요시간:
                                            <span
                                                style="color: #FFF; font-weight: 500; font-size: 18px; padding-right: 12px;"
                                                >약 {{ minutes }}분</span
                                            ></span
                                        >
                                    </span>
                        ...
                        <v-overlay :z-index="zIndex" :value="overlay1">
                            ...
                            >
                                <v-card-text
                                    style="color: #000; width: 100%; height: 237px;"
                                >
                                    <scroll-picker
                                        style="top: 50%; margin-top: -70px; font-style: normal; font-weight: 500; font-size: 16px;"
                    ...
                    <v-flex class="pa-0 mt-1" v-if="callBtn">
                        ...
                        <v-dialog v-model="calldialog" max-width="280">
                            <v-card
                                style="width: 280px; background-color: transparent;"
                            >
                                <v-card
                                    flat
                                ...
                                >
                                    <v-card-text class="pa-3 text-center">
                                        <v-card-text
                                            class="pa-0 call-dialog-title"
                                            >타시오를 호출할게요.</v-card-text
                                        >
                                        <v-card-text
                                            class="pa-0 pt-1 call-dialog-subtitle"
                                            >총 탑승요금</v-card-text
                                        >
                                        <v-card-text
                                            class="pa-0 call-dialog-paymony"
                                            >{{ totalPayment
                                            }}<span
                                    ...
                                    >
                                        <v-card-text
                                            class="pl-3 pr-3 pb-3 pt-2 text-center"
                                        >
                                            <table
                                        ...
                                        <v-card-text
                                            class="pa-0 pt-3 call-dialog-content"
                                            >배차가 완료된 이후에는 호출 취소
                                            시<br />위약금 50%가
                                            발생합니다.</v-card-text
                                        >
                                        ...
                                        <v-card
                                            flat
                                            tile
                                            class="pa-0 ma-0 mt-6"
                                        >
                                            <v-btn
                                                tile
                                                depressed
                                                class="paymentMethod pa-0 mr-6"
                                                :class="{ red: isRed1 }"
                                                :ripple="false"
                                                @click="
                                                    requestPay('617160000106')
                                                "
                                                >신용카드 결제</v-btn
                                            >
                                            <span
                                                ><img
                                                    src="../../assets/check-state.svg"
                                                    v-if="isRed1 == true"
                                                    class="check-state"
                                            /></span>
                                            <v-btn
                                                tile
                                                depressed
                                                class="paymentMethod pa-0"
                                                :class="{ red: isRed2 }"
                                                :ripple="false"
                                                @click="
                                                    requestPay('617160000105')
                                                "
                                                >휴대폰 결제</v-btn
                                            >
                                            <span
                                    ...
                                    <v-card
                                        flat
                                        class="pa-0 pt-2 d-flex align-self-end"
                                    >
    ...
    methods: {
        ...
        async onChange() {
            ...
            this.start_icon = this.$utils.map.createMakerByXY(
                this.map,
                [
                    this.gunsanList[this.start].lat,
                    this.gunsanList[this.start].lon,
                ],
                {
                    icon: startIcon,
                }
                    ...
                    for (let i = 0; i < vehicleCount; i++) {
                        if (vehicle_data[i].site == 1) {
                            ...
                            if (
                                ...
                                this.vehicle[
                                    i
                                ] = await this.$utils.map.createMakerByXY(
                                    this.map,
            ...
            setInterval(
                async function() {
                    axios
                        .get("/api/vehicles/")
                        .then((response) => {
                            var vehicle_data = response.data.sort(function(
                                a,
                                b
                            ) {
                                return a.id < b.id ? -1 : 1;
        ...
        requestCallBtn() {
            ...
            IMP.request_pay({
                ...
                m_redirect_url: `https://ondemand.springgo.io:100/tasio-288c5/us-central1/app/api/payment/put?site=${
                    this.pageId
                }&start=${this.start}&end=${this.end}&startName=${
                    this.start_options[this.start].name
