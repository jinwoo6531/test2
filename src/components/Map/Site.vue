    ...
    methods: {
        ...
        getTimeTable() {
            ...
            axios
                ...
                .then((response) => {
                    console.log(
                        "timetable",
                        response.data.results[0].time_start
                    );
        ...
        cancelPay() {
            ...
            if (this.isrefund == "0") {
                axios({
                    url:
                        "https://connector.tasio.io/tasio-288c5/us-central1/app/api/payment/cancel",
                    method: "post",
                    headers: {
...
.payment-amount  span, .payment-amount  p{
    font-weight: 500;
}
.total_payment {
    width: 90vw;
