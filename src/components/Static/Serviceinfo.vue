      ...
      <v-layout wrap class="ma-0 pt-5">
        <v-flex class="pa-0 pl-6 pr-6" xs12 sm12 md12 style="width: 100%">
          <v-card flat tile color="transparent">
            <v-card-text class="pa-0 service-title"
              >애플리케이션 버전</v-card-text
            >
            <!-- <v-card-text class="pa-0 pb-1 service-content">v 0.3.00</v-card-text> -->
            <v-card-text class="pa-0 pb-1 service-content"
              >v {{ currentVersion }}</v-card-text
            >
        ...
        <v-flex class="pa-0" xs12 sm12 md12 style="width: 100%">
          <v-card flat tile color="transparent">
            <v-card-text class="pa-0 service-title pl-6 pr-6"
              >서비스 정보</v-card-text
            >

            <v-card-text
              class="pa-0 pt-4 pb-3 service-content"
            ...
            <v-card-text
              class="pa-0 pb-3 service-content"
              style="
            ...
            <v-card-text
              class="pa-0 pt-3 service-content"
          ...
          <v-card flat tile color="transparent">
            ...
            <table style="width: 100%; border-bottom: 0.5px solid #e0e0e0">
              ...
              <tr class="service-content">
                <td style="padding-bottom: 13px; padding-left: 24px">
                  (주)스프링클라우드
                </td>
                <td
                  style="
            ...
            <table style="width: 100%; border-bottom: 0.5px solid #e0e0e0">
              <tr class="service-table-title">
                <td style="padding-top: 9px; padding-left: 24px">
                  사업자등록번호
                </td>
            ...
            <table style="width: 100%; border-bottom: 0.5px solid #e0e0e0">
              ...
              <tr class="service-content">
                <td style="padding-bottom: 13px; padding-left: 24px">
                  대구광역시 수성구 알파시티1로 160, 3층 307호 <br />
                  (대흥동, SW융합테크비즈센터)
                </td>
              </tr>
            </table>
            ...
            <table style="width: 100%">
              <tr class="service-table-title">
                <td style="padding-top: 9px; padding-left: 24px">전화</td>
              </tr>
              <tr class="service-content">
                <td style="padding-bottom: 13px; padding-left: 24px">
                  031 778 8328
        ...
        <!-- service 이용약관  -->
        <service :serviceDialog.sync="serviceDialog"></service>
        <privacy :privacyDialog.sync="privacyDialog"></privacy>
        <marketing :marketingDialog.sync="marketingDialog"></marketing>
      </v-layout>
    </v-container>
  </div>
</template>
...
export default {
  components: { service, privacy, marketing },
  data: () => ({
    serviceDialog: false,
    privacyDialog: false,
